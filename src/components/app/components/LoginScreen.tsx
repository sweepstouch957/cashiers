...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-br from-[#FC0680] to-[#FF4DA6] px-6 pt-10 pb-8 flex flex-col">
      <div className="max-w-md mx-auto w-full flex-1 flex flex-col">
        ...
        {/* Footer */}
        <div className="safe-area-bottom mt-8 text-center text-white/90">

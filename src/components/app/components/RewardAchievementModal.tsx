  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 animate-in fade-in">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-sm w-full max-h-[90vh] overflow-y-auto p-6 animate-in zoom-in-95 duration-300">
        <button onClick={onClose} className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 transition-colors z-10">
        ...
        <div className="text-center mb-4">
          <div className="relative inline-block">
            ...
            <div className="absolute -top-2 -right-2 animate-bounce"><Sparkles className="w-5 h-5 text-[#FC0680]" /></div>
            <div className="absolute -bottom-2 -left-2 animate-bounce delay-100"><Sparkles className="w-4 h-4 text-[#FF4DA6]" /></div>
          </div>
          <h2 className="text-foreground mb-1 text-xl">{t.achievement.congrats} 🎉</h2>
          <p className="text-muted-foreground text-sm">{t.achievement.youUnlocked}:</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#FC0680]/10 to-[#FF4DA6]/10 rounded-2xl p-4 mb-4 border-2 border-[#FC0680]/20">
          <div className="mb-3 -mx-4 -mt-4">
            <div className="relative aspect-square bg-white rounded-t-2xl overflow-hidden">
              <img src={reward.imageUrl} alt={reward.name} className="w-full h-full object-contain p-4" />
          ...
          <div className="px-0">
            ...
            <div className="flex gap-2 mb-2">
              ...
              <div className="w-[100px] bg-white/50 rounded-lg p-2.5 min-h-[100px] flex flex-col items-center justify-center">
                <p className="text-xs text-muted-foreground mb-1">{t.achievement.yourPoints}</p>
        ...
        <div className="mb-4 text-center">
          <p className="text-xs text-foreground mb-1">🏆 Amazing work! You've reached {reward.pointsRequired} points!</p>
          <p className="text-xs text-muted-foreground">Keep registering customers to unlock more rewards! 🌟</p>
        </div>

        <div className="space-y-2">
          <button onClick={onRedeem} className="w-full bg-gradient-to-r from-[#FC0680] to-[#FF4DA6] text-white py-2.5 rounded-xl shadow-lg hover:shadow-xl active:scale-98 transition-all font-medium text-sm">
            {t.achievement.redeemNow}
          </button>
          <button onClick={onClose} className="w-full bg-white border-2 border-gray-200 text-foreground py-2.5 rounded-xl hover:bg-gray-50 active:scale-98 transition-all font-medium text-sm">
